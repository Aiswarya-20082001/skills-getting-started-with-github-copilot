...
activities = {
    ...
    "Drama Club": {
        "description": "Theater productions, improvisation, and acting workshops",
        "schedule": "Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["grace@mergington.edu", "harper@mergington.edu"]
    },
    "Robotics Club": {
        "description": "Build and program robots, compete in robotics competitions",
        "schedule": "Mondays and Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["ryan@mergington.edu", "nathan@mergington.edu"]
    },
    "Science Club": {
